    ...
    <section className="section">
      <div className="container">
        <div className="section-head">
          ...
          <p className="section-sub">Stock mis à jour en temps réel</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="empty">
            ...
            <p>Modifiez vos filtres ou contactez-nous.</p>
            <button className="btn btn-ghost" style={{ marginTop: "20px" }} onClick={reset}>Voir tout</button>
          </div>
        ) : (
